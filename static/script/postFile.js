// Post Image custome Btn/Field for UploadField
document.querySelector('.post-image-input').addEventListener('change', function (e) {
    ...
    var fileLabel = document.querySelector('.post-image-label');
